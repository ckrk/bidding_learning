# -*- coding: utf-8 -*-
"""
defines the DDPGAgent class
get_action is basically the Policy function, calling the actor and outputing an action
update refreshes the replay buffer and adapts the target networks
imports replay_buffers, noise, models
