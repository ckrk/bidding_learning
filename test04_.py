...
@author: Viktor
works only for EnMarketEnv08_ and DDPG03_
...
from EnMarketEnv08_ import EnMarketEnv08 



env = EnMarketEnv08(CAP = np.array([500,500,500]), costs = np.array([20,20,20]), Rewards = 3)
...
for episode in range(50):
    ...
    for step in range(500):
        ...
        new_state, reward, done, _ = env.step(action, last_action, last_rewards)   
